      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between w-full gap-8 py-16 px-6 lg:px-12">
        <div className="space-y-6">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <span className="font-bold text-2xl text-white">AfroFinance</span>
          </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-6">
                <div className="text-sm text-slate-400">
                  Made with{" "}
                  <Heart
                    className="h-4 w-4 text-emerald-500 mx-1 inline"
                    fill="currentColor"
                  />{" "}
...
// Default footer component with AfroFinance links
const DefaultFooter = () => {
  const leftLinks = [
  ...
  return (
    <Footer
      ...
      copyrightText={`© ${new Date().getFullYear()} AfroFinance. All rights reserved.`}
      barCount={25}
    />
  );
};
