    ...
    return (
      ...
      >
        <div className="text-center">
          ...
          <p className="text-slate-600">Loading {ticker} chart...</p>
        </div>
      </div>
    );
  }
      ...
      <CardHeader className="border-b">
        ...
        <div className="flex gap-2 mt-2">
          <Button
            ...
            className={
              timeRange === "7d" ? "bg-[#333] hover:bg-[#222] border-0" : ""
            }
          >
            7D
          </Button>
          <Button
            ...
            className={
              timeRange === "30d" ? "bg-[#333] hover:bg-[#222] border-0" : ""
            }
          >
            30D
          </Button>
          <Button
            ...
            className={
              timeRange === "90d" ? "bg-[#333] hover:bg-[#222] border-0" : ""
            }
          >
            90D
          </Button>
        ...
        <ResponsiveContainer width="100%" height={height}>
          <AreaChart data={filteredData}>
            ...
            <Area
              ...
              stroke={chartType === "price" ? "#333" : "#333"}
              strokeWidth={2}
              fill={
